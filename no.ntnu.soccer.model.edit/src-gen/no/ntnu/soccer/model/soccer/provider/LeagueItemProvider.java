...
/**
 * This is the item provider adapter for a {@link no.ntnu.soccer.model.soccer.League} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LeagueItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_League_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_League_name_feature", "_UI_League_type"),
						SoccerPackage.Literals.LEAGUE__NAME, true, false, false,
	...
	protected void addCountryPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_League_country_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_League_country_feature",
								"_UI_League_type"),
						SoccerPackage.Literals.LEAGUE__COUNTRY, true, false, true, null, null, null));
	}
	...
	protected void addSeasonsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_League_seasons_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_League_seasons_feature",
								"_UI_League_type"),
						SoccerPackage.Literals.LEAGUE__SEASONS, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SoccerPackage.Literals.LEAGUE__SEASONS);
			childrenFeatures.add(SoccerPackage.Literals.LEAGUE__TEAMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(SoccerPackage.Literals.LEAGUE__SEASONS, SoccerFactory.eINSTANCE.createSeason()));

		newChildDescriptors
				.add(createChildParameter(SoccerPackage.Literals.LEAGUE__TEAMS, SoccerFactory.eINSTANCE.createTeam()));
	}
