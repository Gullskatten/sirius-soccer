...
public class TeamImpl extends MinimalEObjectImpl.Container implements Team {
	...
	public League getLeague() {
		if (eContainerFeatureID() != SoccerPackage.TEAM__LEAGUE) return null;
	...
	public NotificationChain basicSetLeague(League newLeague, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newLeague, SoccerPackage.TEAM__LEAGUE, msgs);
		return msgs;
	}
	...
	public void setLeague(League newLeague) {
		if (newLeague != eInternalContainer() || (eContainerFeatureID() != SoccerPackage.TEAM__LEAGUE && newLeague != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SoccerPackage.TEAM__LEAGUE, newLeague, newLeague));
	}
