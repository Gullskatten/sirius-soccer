...
public class PlacementItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Placement_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Placement_id_feature",
								"_UI_Placement_type"),
						SoccerPackage.Literals.PLACEMENT__ID, true, false, false,
	...
	protected void addSeasonPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Placement_season_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Placement_season_feature",
								"_UI_Placement_type"),
						SoccerPackage.Literals.PLACEMENT__SEASON, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Placement) object).getId();
		return label == null || label.length() == 0 ? getString("_UI_Placement_type")
