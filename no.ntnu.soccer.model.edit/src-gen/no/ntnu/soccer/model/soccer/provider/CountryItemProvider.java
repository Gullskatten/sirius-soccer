...
/**
 * This is the item provider adapter for a {@link no.ntnu.soccer.model.soccer.Country} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CountryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addIdPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Country_id_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Country_id_feature", "_UI_Country_type"),
                        SoccerPackage.Literals.COUNTRY__ID, true, false, false,
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        SoccerPackage.Literals.COUNTRY__NAME, true, false, false,
    ...
    protected void addLeaguePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Country_league_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Country_league_feature",
                                "_UI_Country_type"),
                        SoccerPackage.Literals.COUNTRY__LEAGUE, true, false, true, null, null, null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SoccerPackage.Literals.COUNTRY__LEAGUE);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(
                createChildParameter(SoccerPackage.Literals.COUNTRY__LEAGUE, SoccerFactory.eINSTANCE.createLeague()));
    }
